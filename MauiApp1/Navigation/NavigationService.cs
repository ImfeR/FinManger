...
namespace UI.Navigation
{
    public class NavigationService : INavigationService
    {
        ...
        public Task NavigateToMainPage()
            => NavigateToPage<MainPageView>();

        public Task NavigateToAddOperationPage()
            => NavigateToPage<AddOperationView>();

        public Task NavigateToAddCategoryPage()
            => NavigateToPage<AddCategoryView>();

        public Task NavigateToShowStatisticPage()
            => NavigateToPage<ShowStatisticPage>();
